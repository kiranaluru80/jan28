...
namespace ConEd.PAP.Models
{
    ...
    public class PolicyDataModel : INotifyPropertyChanged
	{
		public string Name { set; get; }
		...
		//private bool loadingVisibleOrInvisible;

        public event PropertyChangedEventHandler PropertyChanged;

  //      public bool LoadingVisibleOrInvisible
		//{
		//	get { return loadingVisibleOrInvisible; }
		//	set
		//	{
		//		loadingVisibleOrInvisible = value;
  //            // NotifyPropertyChanged("LoadingVisibleOrInvisible");
		//	}
		//}
		...
		{
            //LoadingVisibleOrInvisible = false;
            ...
            pList = pList.OrderBy(a => a.DocName).ToList();
